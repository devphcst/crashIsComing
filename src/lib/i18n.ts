...
const ko: Dict = {
  ...
  notReadyHint:
    '관리자가 초기 ATH와 1년 고점 시드를 입력하면 화면에 수치가 표시됩니다.',
  disclaimer:
  ...
  admin: {
    ...
    seed: '시드값(초기 기준)',
    seedAth: '시드 ATH',
    seedOneYear: '시드 1년 고점',
    seedExplain:
      '시드는 누적 입력이 부족할 때 ATH·1년 고점 계산의 출발선이 되는 값입니다. 새로 입력하는 종가가 시드를 추월하면 자동으로 갱신되므로 한 번만 입력하면 됩니다.',
    seedHowto:
    ...
    seedFieldOneYear: '1년 고점 (최근 365일 최고 종가)',
    split: '분할 일괄 보정',
...
const en: Dict = {
  ...
  oneYearDrawdown: 'vs. 1-year high',
